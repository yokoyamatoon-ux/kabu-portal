...
export const QaPage = () => {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-16 max-w-4xl mx-auto space-y-8">
      <div>
        <h1 className="text-2xl md:text-3xl font-black text-text mb-2 flex items-center gap-2">
          <span>🎓</span> カブ先生の質問箱
        </h1>
      ...
      <div className="bg-white rounded-3xl p-8 border-2 border-gray-100 shadow-xl flex flex-col md:flex-row items-center justify-between gap-8">
         <div className="flex-1 text-center md:text-left">
            <h2 className="text-xl font-black text-text mb-2 flex items-center justify-center md:justify-start gap-2">
