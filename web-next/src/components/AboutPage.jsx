...
export const AboutPage = () => {
  return (
    <div className="space-y-12 pb-20 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 px-4 md:px-0">
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="p-8 text-center rounded-2xl shadow-xl transition-all border-2 bg-white" style={{ backgroundColor: card.color, borderColor: card.border }}>
      ...
      {/* 運営者・監修者情報（E-E-A-T対策） */}
      <div className="bg-white rounded-[2rem] p-8 md:p-10 border border-gray-100 shadow-xl space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
            ...
            <div>
              <div className="font-black text-text mb-1">運営</div>
              <p className="text-muted text-sm font-bold">KABU PORTAL Project</p>
            </div>
          </div>
          <div className="flex items-start gap-6 p-6 bg-secondary-light/30 rounded-xl border border-secondary/20">
            <div className="w-16 h-16 rounded-full bg-secondary-light flex items-center justify-center border-2 border-secondary overflow-hidden shrink-0">
              <img src="/images/kabuhakase_new.png" alt="カブ先生" className="w-12 h-12 object-contain" />
            </div>
            <div>
              <div className="font-black text-text mb-1">監修：カブ先生</div>
              <p className="text-muted text-sm font-bold leading-relaxed">
                元証券会社勤務・個人投資歴30年。2026年よりお金の学校を運営。<br />
                本サイトのコンテンツはカブ先生が内容を確認・監修しています。
              </p>
            </div>
          </div>
          <div className="p-4 bg-amber-50 rounded-xl border border-amber-200">
            <p className="text-xs text-amber-700 font-bold leading-relaxed">
              ※本サイトの情報は、投資経験のある個人が教育目的で作成しています。<br />
      ...
      <div className="bg-gradient-to-br from-primary-light to-white rounded-[3rem] p-10 md:p-14 border-4 border-white shadow-2xl relative overflow-hidden text-center space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10 max-w-2xl mx-auto">
          <div className="p-6 bg-white border-2 border-gray-100 hover:border-primary transition-all group flex flex-col items-center gap-4 rounded-2xl shadow-xl">
