...
# --- メイン処理 ---
IMAGE_PATH = r"D:\Antigravity\Kabu\image\note\01.png"

parent_text = """フォッフォッフォ！皆様に大切なお知らせじゃ。

カブ先生、この度『note』を始めたぞい！✨

投資のさらに深い話や、サイトの裏側なども発信していく予定じゃ。
まずはワシの自己紹介を読んでみておくれ。

#note #投資初心者 #お金の学び場"""

reply_text = """記念すべき初投稿はこちらからチェックじゃ！👇

【自己紹介】はじめまして、カブ先生じゃ。難しい投資を日本一ポップに教えるぞい！
https://note.com/kabu_teacher/n/n82c6d8531540

#カブ先生 #資産運用"""

print("🚀 note開設記念のX投稿を開始します...")
...
if media_id:
    ...
    if parent_id:
        ...
        if reply_id:
            ...
            log_post_to_history("general", parent_text, IMAGE_PATH, "success", parent_id)
            print("\n✨ すべての投稿が完了しました！")
        else:
