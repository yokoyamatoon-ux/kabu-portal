...
def post_column_20260331():
    ...
    # 投稿設定
    image_path = r"D:\Antigravity\Kabu\manga\column\Column20260331.png"
    article_url = "https://okane-no-manabi.jp/?page=column_detail&id=col_009"

    # 1ツイート目（画像付き）
    tweet1_text = """【新NISAの始め方、3ステップで解説！】
「NISAってお得そうだけど、難しそう……」と足踏みしていませんか？💰
実はスマホ一つで、最短5分から始められるんです！📱

カブ先生が初心者向けの最短ルートを伝授します！📖
