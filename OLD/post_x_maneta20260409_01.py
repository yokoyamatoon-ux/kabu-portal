...
def post_maneta20260409_01():
    ...
    # 1ツイート目（画像付き）
    tweet1_text = """初めての投資はやっぱりドキドキ！💓

マネ太がついに「オルカン」をぽちっと注文📱
自分の1万円が世界中の会社を応援しに行くって考えるとワクワクしますね🌏✨

#投資初心者 #新NISA #オルカン #お金の勉強"""

    # 2ツイート目（サイト紹介・リプライ）
    tweet2_text = """▼ 続きやマネ太たちの投資の成長はサイトで！

「お金のまなび場」では、投資の基本から実践的な知識までマンガでやさしく解説しています📚 完全無料！
