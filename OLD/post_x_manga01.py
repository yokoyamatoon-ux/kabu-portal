...
def post_manga01():
    ...
    # 投稿内容の設定
    # ==============================
    image_path = r"D:\Antigravity\Kabu\manga\Manga01.jpg"

    # 1ツイート目（画像付き）
    tweet1_text = """📖 こんなマンガで投資を学べるサイト作りました！

カブ先生とマネ太が、むずかしいお金の話をゆる～く教えてくれます💰
...
「お金のまなび場」は、マンガと解説でお金・投資をわかりやすく学べる無料サービスです📚

🔗 https://okane-no-manabi.jp/

コラムや用語集も充実！ぜひのぞいてみてください✨"""
    ...
    for label, text, pts in [("1ツイート目", tweet1_text, p1), ("2ツイート目", tweet2_text, p2)]:
        if pts > 280:
