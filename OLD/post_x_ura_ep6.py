...
def post_ura_ep6():
    ...
    # 正しい画像パス
    image_path = r"D:\Antigravity\Kabu\manga\urakane\urakane20260414.png"
    
    # 1. 親ツイート内容
    parent_text = """【実録：ウラ金の裏事情ファイル 第6話】

マネ太：「『マネマネコイン』、次爆上げ確定ってSNSで有名人が言ってるっす！ボクも億り人に！？」
ウラ金：「ヒッヒッ……そのロケット、運営が売り抜けてドロンする『ラグプル』の臭いがプンプンするぜ🕶️」

#仮想通貨詐欺 #カブ先生"""

    # 2. 返信内容（スレッド）
    reply_text = """▼ 進化するデジタル詐欺を見破れ！
仮想通貨投資に潜む「3つの罠」と身を守る方法を解説！
続きはWebサイトでチェックじゃ！
https://okane-no-manabi.jp/?ep=6
