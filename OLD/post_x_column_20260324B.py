...
def post_column_20260324B():
    ...
    # 投稿設定
    image_path = r"D:\Antigravity\Kabu\manga\column\Column_20260324B.png"
    article_url = "https://okane-no-manabi.jp/?page=column_detail&id=col_006"

    # 1ツイート目（画像付き）
    tweet1_text = """【デジタル・ユーロって何？私たちの生活はどう変わる？】
PayPayなどのキャッシュレス決済と何が違うの？🤔
欧州で準備が進む「デジタル・ユーロ」の正体とは……。

中銀デジタル通貨（CBDC）がもたらす未来を、カブ先生が解説！📖

#デジタル通貨 #CBDC #経済 #お金の勉強"""

    # 2ツイート目（コラム詳細・リプライ）
    tweet2_text = f"""▼ 続きはこちらのコラムへ！
{article_url}

「中央銀行が直接発行するデジタルな現金」のメリットや、日本への影響について分かりやすくまとめています📚

お金の形が変わる転換点を先読みしましょう✨"""
