...
def post_column_20260413():
    ...
    # 投稿設定
    image_path = r"D:\Antigravity\Kabu\web\public\images\column\Column20260413.png"
    article_url = "https://okane-no-manabi.jp/?page=column_detail&id=col_013"

    # 1ツイート目（画像付き）
    tweet1_text = """【S&P500 vs オルカン（全世界株式）】
「NISAで投資を始めるなら、どっちがいいの？」💰
初心者全員がぶつかるこの『永遠のテーマ』にカブ先生が結論を出します！🎓

一番の失敗は「S&P500」でも「オルカン」を選ぶことでもありません🤔
...
・S&P500とオルカンの「中身」の違い
・どっちがあなたに向いているのか？💡
・カブ先生が教える「一番やってはいけない失敗」とは？

さぁ、カブ先生からのメッセージを読んで、投資家の第一歩を踏み出してみましょう✨"""
    ...
    print(f"\n🎉 スレッド投稿完了！")
    print(f"🔗 投稿URL: https://x.com/nanda_antigravity/status/{parent_id}")

if __name__ == "__main__":
    post_column_20260413()
