(function() {
    ...
    var PSLocalization = {
         ...
         */
        HEADER_GETHELP_LINK : "http://gr.trendmicro.com/GREntry/NonPayment?PID=TEG0&Locale=FR-FR&SP=F&VID=&Target=OLH&FunID=100002",
        /*
         overlay area
         */
        ...
        CONCERN_TITLE : "%d problèmes de confidentialité ont été détectés.",
        CONCERN_TITLE_ONE_CONCERN : "%d problème de confidentialité a été détecté.",
        ...
        CATEGORY_Application_access : "%NUM% application et ses publications sont visibles",
        CATEGORY_Application_access_plural : "%NUM% applications et leurs publications sont visibles",
        ...
        HTML_FOOTER_COPYRIGHT : "Copyright © 2025 Trend Micro Incorporated. Tous droits réservés.",
        ...
        ENABLE_TOOLBAR_LINK : "http://gr.trendmicro.com/GREntry/NonPayment?TARGET=iKB&FunID=Privacy_Scan_2&Locale=FR-FR",
        ...
        ALERT_LOG_IN_SAFAFI_NEED_CHECKED_WHEN_SCAN : "Pour vérifier vos paramètres de confidentialité, commencez par vous connecter et n'oubliez pas de cocher la case « Garder ma session ouverte ».",
        ALERT_LOG_IN_SAFAFI_NEED_CHECKED_WHEN_FIX : "Pour corriger les problèmes de confidentialité détectés, commencez par vous connecter et n'oubliez pas de cocher la case « Garder ma session ouverte ».",
        ...
        ALERT_CHROME_ACCOUNT_LOGGED_IN_LEARN_MORE : "Cliquez ici afin d'obtenir des instructions simples pour résoudre le problème.",
        ...
        */
        ...
        ERROR_IE_VERSION_TOO_LOW : "Mettez à niveau vers la version la plus récente de Microsoft Internet Explorer avant de cliquer sur le bouton ci-dessous.",
        
        ERROR_DEFAULT_TITLE : "Une erreur s'est produite. Réessayez ultérieurement.",
        ERROR_DEFAULT_LEARN_MORE : "En savoir plus",
        
        /*
            IE6/7 error message
        */
        UPDATE_TO_LATEST_IE : "Mettez à niveau vers la version la plus récente de Microsoft Internet Explorer.",
        ...
        */
        ...
        cr_remember_sign_on_value_1_POSSIBLEVALUE : "Désactivé",
        ...
        */
        ...
        ie_remember_password_TITLE : "Utiliser la saisie semi-automatique pour les noms d'utilisateur et les mots de passe dans les formulaires",
        ...
        // ie_private_mode
        ie_private_mode_TITLE : "Désactiver les barres d'outils et les extensions au démarrage de la navigation InPrivate",
        ...
        fb_google_plus_on_IE8:"Google+ ne prend pas en charge Internet Explorer 8. Ouvrez Google+ dans un autre navigateur ou mettez à niveau vers la dernière version d'Internet Explorer.",
