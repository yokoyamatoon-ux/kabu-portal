(() => {
    var e = {
        893(e) {
            ...
            e.exports = function(e, a = {}) {
                ...
                var n = e.querySelectorAll("p, pre, article"), r = e.querySelectorAll("div > br");
                if (r.length) {
                    var s = new Set(n);
                ...
                return [].some.call(n, (function(e) {
                    ...
                    var n = e.textContent.trim().length;
                    return !(n < a.minContentLength) && (o += Math.sqrt(n - a.minContentLength)) > a.minScore;
                }));
            };
        },
        174(e) {
            function t(e, t) {
                if (t && t.documentElement) e = t, t = arguments[2]; else if (!e || !e.documentElement) throw Error("First argument to Readability constructor should be a document object.");
                if (t = t || {}, this._doc = e, this._docJSDOMParser = this._doc.firstChild.__JSDOMParser__, 
                this._articleTitle = null, this._articleByline = null, this._articleDir = null, 
                this._articleSiteName = null, this._attempts = [], this._debug = !!t.debug, this._maxElemsToParse = t.maxElemsToParse || this.DEFAULT_MAX_ELEMS_TO_PARSE, 
                this._nbTopCandidates = t.nbTopCandidates || this.DEFAULT_N_TOP_CANDIDATES, this._charThreshold = t.charThreshold || this.DEFAULT_CHAR_THRESHOLD, 
                this._classesToPreserve = this.CLASSES_TO_PRESERVE.concat(t.classesToPreserve || []), 
                this._keepClasses = !!t.keepClasses, this._serializer = t.serializer || function(e) {
                    return e.innerHTML;
                }, this._disableJSONLD = !!t.disableJSONLD, this._flags = this.FLAG_STRIP_UNLIKELYS | this.FLAG_WEIGHT_CLASSES | this.FLAG_CLEAN_CONDITIONALLY, 
                this._debug) {
                    let e = function(e) {
                        return e.nodeType == e.TEXT_NODE ? `${e.nodeName} ("${e.textContent}")` : `<${e.localName} ${Array.from(e.attributes || [], (function(e) {
            ...
            t.prototype = {
                ...
                _removeNodes: function(e, t) {
                    ...
                    for (var i = e.length - 1; i >= 0; i--) {
                        var a = e[i], n = a.parentNode;
                        n && (!t || t.call(this, a, i, e)) && n.removeChild(a);
                    }
                },
                ...
                _concatNodeLists: function() {
                    var e = Array.prototype.slice, t = e.call(arguments).map((function(t) {
                        return e.call(t);
                    }));
                ...
                _cleanClasses: function(e) {
                    var t = this._classesToPreserve, i = (e.getAttribute("class") || "").split(/\s+/).filter((function(e) {
                ...
                _fixRelativeUris: function(e) {
                    var t = this._doc.baseURI, i = this._doc.documentURI;
                    function a(e) {
                    ...
                    this._forEachNode(n, (function(e) {
                        ...
                        if (t) if (0 === t.indexOf("javascript:")) if (1 === e.childNodes.length && e.childNodes[0].nodeType === this.TEXT_NODE) {
                            var i = this._doc.createTextNode(e.textContent);
                            e.parentNode.replaceChild(i, e);
                        } else {
                            for (var n = this._doc.createElement("span"); e.firstChild; ) n.appendChild(e.firstChild);
                            e.parentNode.replaceChild(n, e);
                        } else e.setAttribute("href", a(t));
                    }));
                    var r = this._getAllNodesWithTag(e, [ "img", "picture", "figure", "video", "audio", "source" ]);
                    this._forEachNode(r, (function(e) {
                        var t = e.getAttribute("src"), i = e.getAttribute("poster"), n = e.getAttribute("srcset");
                        if (t && e.setAttribute("src", a(t)), i && e.setAttribute("poster", a(i)), n) {
                            var r = n.replace(this.REGEXPS.srcsetUrl, (function(e, t, i, n) {
                                return a(t) + (i || "") + n;
                            }));
                ...
                _getArticleTitle: function() {
                    ...
                    if (/ [\|\-\\\/>»] /.test(t)) a = / [\\\/>»] /.test(t), 3 > n(t = i.replace(/(.*)[\|\-\\\/>»] .*/gi, "$1")) && (t = i.replace(/[^\|\-\\\/>»]*[\|\-\\\/>»](.*)/gi, "$1")); else if (-1 !== t.indexOf(": ")) {
                        var r = this._concatNodeLists(e.getElementsByTagName("h1"), e.getElementsByTagName("h2")), s = t.trim();
                        !this._someNode(r, (function(e) {
                            return e.textContent.trim() === s;
                        })) && (3 > n(t = i.substring(i.lastIndexOf(":") + 1)) ? t = i.substring(i.indexOf(":") + 1) : n(i.substr(0, i.indexOf(":"))) > 5 && (t = i));
                    ...
                    return l <= 4 && (!a || l != n(i.replace(/[\|\-\\\/>»]+/g, "")) - 1) && (t = i), 
                    t;
                },
                _prepDocument: function() {
                    var e = this._doc;
                    this._removeNodes(this._getAllNodesWithTag(e, [ "style" ])), e.body && this._replaceBrs(e.body), 
                ...
                _replaceBrs: function(e) {
                    this._forEachNode(this._getAllNodesWithTag(e, [ "br" ]), (function(e) {
                        for (var t = e.nextSibling, i = !1; (t = this._nextNode(t)) && "BR" == t.tagName; ) {
                            i = !0;
                            var a = t.nextSibling;
                        ...
                        if (i) {
                            ...
                            for (e.parentNode.replaceChild(n, e), t = n.nextSibling; t; ) {
                                if ("BR" == t.tagName) {
                                    var r = this._nextNode(t.nextSibling);
                ...
                _setNodeTag: function(e, t) {
                    if (this.log("_setNodeTag", e, t), this._docJSDOMParser) return e.localName = t.toLowerCase(), 
                    e.tagName = t.toUpperCase(), e;
                ...
                _prepArticle: function(e) {
                    this._cleanStyles(e), this._markDataTables(e), this._fixLazyImages(e), this._cleanConditionally(e, "form"), 
                    this._cleanConditionally(e, "fieldset"), this._clean(e, "object"), this._clean(e, "embed"), 
                    this._clean(e, "footer"), this._clean(e, "link"), this._clean(e, "aside");
                    ...
                    this._clean(e, "select"), this._clean(e, "button"), this._cleanHeaders(e), this._cleanConditionally(e, "table"), 
                    this._cleanConditionally(e, "ul"), this._cleanConditionally(e, "div"), this._replaceNodeTags(this._getAllNodesWithTag(e, [ "h1" ]), "h2"), 
                    this._removeNodes(this._getAllNodesWithTag(e, [ "p" ]), (function(e) {
                        ...
                        if (this._hasSingleTagInsideElement(t, "TR")) {
                            ...
                            if (this._hasSingleTagInsideElement(i, "TD")) {
                                ...
                                a = this._setNodeTag(a, this._everyNode(a.childNodes, this._isPhrasingContent) ? "P" : "DIV"), 
                ...
                _textSimilarity: function(e, t) {
                    var i = e.toLowerCase().split(this.REGEXPS.tokenize).filter(Boolean), a = t.toLowerCase().split(this.REGEXPS.tokenize).filter(Boolean);
                    return i.length && a.length ? 1 - a.filter((e => !i.includes(e))).join(" ").length / a.join(" ").length : 0;
                },
                _checkByline: function(e, t) {
                    if (this._articleByline) return !1;
                    if (void 0 !== e.getAttribute) var i = e.getAttribute("rel"), a = e.getAttribute("itemprop");
                    return !(!("author" === i || a && -1 !== a.indexOf("author") || this.REGEXPS.byline.test(t)) || !this._isValidByline(e.textContent) || (this._articleByline = e.textContent.trim(), 
                    0));
                },
                ...
                _grabArticle: function(e) {
                    ...
                    if (!(e = e || this._doc.body)) return this.log("No body found in document. Abort."), 
                    null;
                    for (var a = e.innerHTML; ;) {
                        this.log("Starting grabArticle loop");
                        var n, r = this._flagIsActive(this.FLAG_STRIP_UNLIKELYS), s = [], o = this._doc.documentElement;
                        let $ = !0;
                        for (;o; ) {
                            "HTML" === o.tagName && (this._articleLang = o.getAttribute("lang"));
                            var l = o.className + " " + o.id;
                            if (this._isProbablyVisible(o)) if (this._checkByline(o, l)) o = this._removeAndGetNext(o); else if ($ && this._headerDuplicatesTitle(o)) this.log("Removing header: ", o.textContent.trim(), this._articleTitle.trim()), 
                            $ = !1, o = this._removeAndGetNext(o); else {
                                if (r) {
                                ...
                                if ("DIV" !== o.tagName && "SECTION" !== o.tagName && "HEADER" !== o.tagName && "H1" !== o.tagName && "H2" !== o.tagName && "H3" !== o.tagName && "H4" !== o.tagName && "H5" !== o.tagName && "H6" !== o.tagName || !this._isElementWithoutContent(o)) {
                                    if (-1 !== this.DEFAULT_TAGS_TO_SCORE.indexOf(o.tagName) && s.push(o), "DIV" === o.tagName) {
                                        for (var d = null, h = o.firstChild; h; ) {
                                            var c = h.nextSibling;
                                            if (this._isPhrasingContent(h)) null !== d ? d.appendChild(h) : this._isWhitespace(h) || (d = t.createElement("p"), 
                                            o.replaceChild(d, h), d.appendChild(h)); else if (null !== d) {
                        ...
                        this._forEachNode(s, (function(e) {
                            if (e.parentNode && void 0 !== e.parentNode.tagName) {
                                ...
                                if (!(t.length < 25)) {
                                    ...
                                    if (0 !== i.length) {
                                        var a = 0;
                                        a += 1, a += t.split(",").length, a += Math.min(Math.floor(t.length / 100), 3), 
                                        this._forEachNode(i, (function(e, t) {
                                            if (e.tagName && e.parentNode && void 0 !== e.parentNode.tagName) {
                                                if (void 0 === e.readability && (this._initializeNode(e), u.push(e)), 0 === t) var i = 1; else i = 1 === t ? 2 : 3 * t;
                        ...
                        for (var m = [], _ = 0, p = u.length; _ < p; _ += 1) {
                            var f = u[_], v = f.readability.contentScore * (1 - this._getLinkDensity(f));
                        ...
                        if (null === E || "BODY" === E.tagName) {
                            for (E = t.createElement("DIV"), T = !0; e.firstChild; ) this.log("Moving child out:", e.firstChild), 
                            ...
                            if (y.length >= 3) for (n = E.parentNode; "BODY" !== n.tagName; ) {
                                for (var C = 0, S = 0; S < y.length && C < 3; S++) C += Number(y[S].includes(n));
                                if (C >= 3) {
                                    E = n;
                                    break;
                                }
                            ...
                            E.readability || this._initializeNode(E), n = E.parentNode;
                            for (var L = E.readability.contentScore, x = L / 3; "BODY" !== n.tagName; ) if (n.readability) {
                                var I = n.readability.contentScore;
                                if (I < x) break;
                                if (I > L) {
                                    E = n;
                                    break;
                                }
                                L = n.readability.contentScore, n = n.parentNode;
                            } else n = n.parentNode;
                            for (n = E.parentNode; "BODY" != n.tagName && 1 == n.children.length; ) n = (E = n).parentNode;
                            E.readability || this._initializeNode(E);
                        }
                        var R = t.createElement("DIV");
                        i && (R.id = "readability-content");
                        for (var D = Math.max(10, .2 * E.readability.contentScore), O = (n = E.parentNode).children, P = 0, w = O.length; P < w; P++) {
                            var B = O[P], k = !1;
                            if (this.log("Looking at sibling node:", B, B.readability ? "with score " + B.readability.contentScore : ""), 
                            this.log("Sibling has score", B.readability ? B.readability.contentScore : "Unknown"), 
                            B === E) k = !0; else {
                                var M = 0;
                                if (B.className === E.className && "" !== E.className && (M += .2 * E.readability.contentScore), 
                                B.readability && B.readability.contentScore + M >= D) k = !0; else if ("P" === B.nodeName) {
                                    var G = this._getLinkDensity(B), H = this._getInnerText(B), U = H.length;
                                    (U > 80 && G < .25 || U < 80 && U > 0 && 0 === G && -1 !== H.search(/\.( |$)/)) && (k = !0);
                                }
                            }
                            k && (this.log("Appending node:", B), -1 === this.ALTER_TO_DIV_EXCEPTIONS.indexOf(B.nodeName) && (this.log("Altering sibling:", B, "to div."), 
                            B = this._setNodeTag(B, "DIV")), R.appendChild(B), O = n.children, P -= 1, w -= 1);
                        }
                        if (this._debug && this.log("Article content pre-prep: " + R.innerHTML), this._prepArticle(R), 
                        this._debug && this.log("Article content post-prep: " + R.innerHTML), T) E.id = "readability-page-1", 
                        E.className = "page"; else {
                            var W = t.createElement("DIV");
                            for (W.id = "readability-page-1", W.className = "page"; R.firstChild; ) W.appendChild(R.firstChild);
                            R.appendChild(W);
                        }
                        this._debug && this.log("Article content after paging: " + R.innerHTML);
                        var F = !0, X = this._getInnerText(R, !0).length;
                        if (X < this._charThreshold) if (F = !1, e.innerHTML = a, this._flagIsActive(this.FLAG_STRIP_UNLIKELYS)) this._removeFlag(this.FLAG_STRIP_UNLIKELYS), 
                        this._attempts.push({
                            articleContent: R,
                            textLength: X
                        ...
                        if (F) {
                            var j = [ n, E ].concat(this._getNodeAncestors(n));
                ...
                _getJSONLD: function(e) {
                    ...
                    return this._forEachNode(i, (function(e) {
                        if (!t && "application/ld+json" === e.getAttribute("type")) try {
                            var i = e.textContent.replace(/^\s*<!\[CDATA\[|\]\]>\s*$/g, ""), a = JSON.parse(i);
                            ...
                            if (t = {}, "string" == typeof a.name && "string" == typeof a.headline && a.name !== a.headline) {
                                var n = this._getArticleTitle(), r = this._textSimilarity(a.name, n) > .75;
                                this._textSimilarity(a.headline, n) > .75 && !r ? t.title = a.headline : t.title = a.name;
                            ...
                            return a.author && ("string" == typeof a.author.name ? t.byline = a.author.name.trim() : Array.isArray(a.author) && a.author[0] && "string" == typeof a.author[0].name && (t.byline = a.author.filter((function(e) {
                                ...
                                return e.name.trim();
                            })).join(", "))), "string" == typeof a.description && (t.excerpt = a.description.trim()), 
                            void (a.publisher && "string" == typeof a.publisher.name && (t.siteName = a.publisher.name.trim()));
                        } catch (e) {
                            this.log(e.message);
                        }
                    })), t || {};
                ...
                _getArticleMetadata: function(e) {
                    var t = {}, i = {}, a = this._doc.getElementsByTagName("meta"), n = /\s*(dc|dcterm|og|twitter)\s*:\s*(author|creator|description|title|site_name)\s*/gi, r = /^\s*(?:(dc|dcterm|og|twitter|weibo:(article|webpage))\s*[\.:]\s*)?(author|creator|description|title|site_name)\s*$/i;
                    return this._forEachNode(a, (function(e) {
                        var t = e.getAttribute("name"), a = e.getAttribute("property"), s = e.getAttribute("content");
                        if (s) {
                            var o = null, l = null;
                            a && (o = a.match(n)) && (i[l = o[0].toLowerCase().replace(/\s/g, "")] = s.trim()), 
                            !o && t && r.test(t) && (l = t, s && (i[l = l.toLowerCase().replace(/\s/g, "").replace(/\./g, ":")] = s.trim()));
                        }
                    })), t.title = e.title || i["dc:title"] || i["dcterm:title"] || i["og:title"] || i["weibo:article:title"] || i["weibo:webpage:title"] || i.title || i["twitter:title"], 
                    t.title || (t.title = this._getArticleTitle()), t.byline = e.byline || i["dc:creator"] || i["dcterm:creator"] || i.author, 
                    t.excerpt = e.excerpt || i["dc:description"] || i["dcterm:description"] || i["og:description"] || i["weibo:article:description"] || i["weibo:webpage:description"] || i.description || i["twitter:description"], 
                    t.siteName = e.siteName || i["og:site_name"], t.title = this._unescapeHtmlEntities(t.title), 
                    t.byline = this._unescapeHtmlEntities(t.byline), t.excerpt = this._unescapeHtmlEntities(t.excerpt), 
                    t.siteName = this._unescapeHtmlEntities(t.siteName), t;
                },
                    ...
                    this._forEachNode(i, (function(t) {
                        ...
                        if (i.innerHTML = t.innerHTML, this._isSingleImage(i)) {
                            ...
                            if (a && this._isSingleImage(a)) {
                                var n = a;
                                "IMG" !== n.tagName && (n = a.getElementsByTagName("img")[0]);
                                for (var r = i.getElementsByTagName("img")[0], s = 0; s < n.attributes.length; s++) {
                                    var o = n.attributes[s];
                                    if ("" !== o.value && ("src" === o.name || "srcset" === o.name || /\.(jpg|jpeg|png|webp)/i.test(o.value))) {
                                        if (r.getAttribute(o.name) === o.value) continue;
                                        var l = o.name;
                                        r.hasAttribute(l) && (l = "data-old-" + l), r.setAttribute(l, o.value);
                                    }
                                }
                ...
                _cleanStyles: function(e) {
                    if (e && "svg" !== e.tagName.toLowerCase()) {
                        for (var t = 0; t < this.PRESENTATIONAL_ATTRIBUTES.length; t++) e.removeAttribute(this.PRESENTATIONAL_ATTRIBUTES[t]);
                        -1 !== this.DEPRECATED_SIZE_ATTRIBUTE_ELEMS.indexOf(e.tagName) && (e.removeAttribute("width"), 
                ...
                _getLinkDensity: function(e) {
                    ...
                    return this._forEachNode(e.getElementsByTagName("a"), (function(e) {
                        var t = e.getAttribute("href"), a = t && this.REGEXPS.hashUrl.test(t) ? .3 : 1;
                        i += this._getInnerText(e).length * a;
                    })), i / t;
                },
                _getClassWeight: function(e) {
                    if (!this._flagIsActive(this.FLAG_WEIGHT_CLASSES)) return 0;
                    var t = 0;
                    return "string" == typeof e.className && "" !== e.className && (this.REGEXPS.negative.test(e.className) && (t -= 25), 
                    this.REGEXPS.positive.test(e.className) && (t += 25)), "string" == typeof e.id && "" !== e.id && (this.REGEXPS.negative.test(e.id) && (t -= 25), 
                    this.REGEXPS.positive.test(e.id) && (t += 25)), t;
                },
                _clean: function(e, t) {
                    var i = -1 !== [ "object", "embed", "iframe" ].indexOf(t);
                    this._removeNodes(this._getAllNodesWithTag(e, [ t ]), (function(e) {
                        if (i) {
                            for (var t = 0; t < e.attributes.length; t++) if (this.REGEXPS.videos.test(e.attributes[t].value)) return !1;
                ...
                _hasAncestorTag: function(e, t, i, a) {
                    ...
                    for (var n = 0; e.parentNode && (!(i > 0) || !(n > i)); ) {
                ...
                _getRowAndColumnCount: function(e) {
                    for (var t = 0, i = 0, a = e.getElementsByTagName("tr"), n = 0; n < a.length; n++) {
                        var r = a[n].getAttribute("rowspan") || 0;
                        r && (r = parseInt(r, 10)), t += r || 1;
                        for (var s = 0, o = a[n].getElementsByTagName("td"), l = 0; l < o.length; l++) {
                ...
                _markDataTables: function(e) {
                    for (var t = e.getElementsByTagName("table"), i = 0; i < t.length; i++) {
                        var a = t[i];
                        if ("presentation" != a.getAttribute("role") && "0" != a.getAttribute("datatable")) if (a.getAttribute("summary")) a._readabilityDataTable = !0; else {
                            var n = a.getElementsByTagName("caption")[0];
                            if (n && n.childNodes.length > 0) a._readabilityDataTable = !0; else if ([ "col", "colgroup", "tfoot", "thead", "th" ].some((function(e) {
                                return !!a.getElementsByTagName(e)[0];
                            }))) this.log("Data table because found data-y descendant"), a._readabilityDataTable = !0; else if (a.getElementsByTagName("table")[0]) a._readabilityDataTable = !1; else {
                                var r = this._getRowAndColumnCount(a);
                                r.rows >= 10 || r.columns > 4 ? a._readabilityDataTable = !0 : a._readabilityDataTable = r.rows * r.columns > 10;
                            }
                ...
                _fixLazyImages: function(e) {
                    this._forEachNode(this._getAllNodesWithTag(e, [ "img", "picture", "figure" ]), (function(e) {
                        if (e.src && this.REGEXPS.b64DataUrl.test(e.src)) {
                            ...
                            if (t) {
                                var n = e.src.search(/base64\s*/i) + 7;
                                e.src.length - n < 133 && e.removeAttribute("src");
                            }
                        }
                        if (!e.src && (!e.srcset || "null" == e.srcset) || -1 !== e.className.toLowerCase().indexOf("lazy")) for (var r = 0; r < e.attributes.length; r++) if ("src" !== (a = e.attributes[r]).name && "srcset" !== a.name && "alt" !== a.name) {
                            var s = null;
                            if (/\.(jpg|jpeg|png|webp)\s+\d/.test(a.value) ? s = "srcset" : /^\s*\S+\.(jpg|jpeg|png|webp)\S*\s*$/.test(a.value) && (s = "src"), 
                            s) if ("IMG" === e.tagName || "PICTURE" === e.tagName) e.setAttribute(s, a.value); else if ("FIGURE" === e.tagName && !this._getAllNodesWithTag(e, [ "img", "picture" ]).length) {
                ...
                _getTextDensity: function(e, t) {
                    ...
                    if (0 === i) return 0;
                    var a = 0, n = this._getAllNodesWithTag(e, t);
                    return this._forEachNode(n, (e => a += this._getInnerText(e, !0).length)), a / i;
                },
                _cleanConditionally: function(e, t) {
                    this._flagIsActive(this.FLAG_CLEAN_CONDITIONALLY) && this._removeNodes(this._getAllNodesWithTag(e, [ t ]), (function(e) {
                        ...
                        if (!a) {
                            var n = 0, r = this._getAllNodesWithTag(e, [ "ul", "ol" ]);
                            this._forEachNode(r, (e => n += this._getInnerText(e).length)), a = n / this._getInnerText(e).length > .9;
                        }
                        ...
                        if (10 > this._getCharCount(e, ",")) {
                            for (var o = e.getElementsByTagName("p").length, l = e.getElementsByTagName("img").length, d = e.getElementsByTagName("li").length - 100, h = e.getElementsByTagName("input").length, c = this._getTextDensity(e, [ "h1", "h2", "h3", "h4", "h5", "h6" ]), g = 0, u = this._getAllNodesWithTag(e, [ "object", "embed", "iframe" ]), m = 0; m < u.length; m++) {
                                for (var _ = 0; _ < u[m].attributes.length; _++) if (this.REGEXPS.videos.test(u[m].attributes[_].value)) return !1;
                                if ("object" === u[m].tagName && this.REGEXPS.videos.test(u[m].innerHTML)) return !1;
                                g++;
                            }
                            var p = this._getLinkDensity(e), f = this._getInnerText(e).length;
                ...
                parse: function() {
                    ...
                    if (this.log("Grabbed: " + a.innerHTML), this._postProcessContent(a), !i.excerpt) {
                        var n = a.getElementsByTagName("p");
                        n.length > 0 && (i.excerpt = n[0].textContent.trim());
                    }
                    var r = a.textContent;
                    return {
    ...
    i.n = e => {
        ...
        var a = new e.Readability(document.cloneNode(!0)).parse();
        function n(e) {
            let t = chrome.runtime.getURL(e), i = document.createElement("link");
            return i.setAttribute("rel", "stylesheet"), i.setAttribute("type", "text/css"), 
            i.setAttribute("href", t), i;
        }
        function r(e) {
            var t, i, a;
            null === (t = o("readergpt__readableText")) || void 0 === t || t.classList.remove("d-none"), 
            null === (i = o("readergpt__readableText")) || void 0 === i || i.classList.remove("alert-secondary"), 
            null === (a = o("readergpt__readableText")) || void 0 === a || a.classList.add("alert-warning"), 
            o("readergpt__readableText").innerText = e;
        }
        function s() {
            var e, t, i;
            null === (e = o("readergpt__gifContainer")) || void 0 === e || e.classList.add("d-none"), 
            null === (t = o("readergpt__gifContainer")) || void 0 === t || t.classList.remove("loading"), 
            null === (i = o("readergpt__loginContainer")) || void 0 === i || i.classList.remove("loading");
        }
        function o(e) {
            var t, i;
        ...
        chrome.runtime.onMessage.addListener(((e, t, i) => {
            ...
            a.id = t, a.style.cssText = "font-size: 16px;", a.attachShadow({
                mode: "open"
            }), (null == a ? void 0 : a.shadowRoot) && (a.shadowRoot.appendChild(n("css/content.css")), 
            a.shadowRoot.appendChild(n("css/popup.css")));
            let r = document.createElement("div");
            r.id = "readergpt__container", r.className = "readergpt__container readergpt-styles";
            let s = chrome.runtime.getURL("svgfiles/logo.svg"), l = chrome.runtime.getURL("settings.html"), d = chrome.runtime.getURL("svgfiles/star.svg"), h = chrome.runtime.getURL("svgfiles/copy.svg");
            r.innerHTML = `<div class="readergpt__main__wrapper">\n      <nav class="navbar navbar-light bg-light sticky-top pt-0 pb-0">\n        <div id="readergpt__navContainer" class="container">\n          <div class="navbar-brand">\n            <img src="${s}" style="width: 24px; height: 24px;" class="d-inline-block align-text-middle">\n            <span id="readergpt__navbarTitle" class="align-middle h6">Summary Webpage</span>\n          </div>\n          <div class="readergpt__headerBtnsWrapper">\n            <button type="button" class="btn btn-settings"><a href="${l}" target="_blank"></a></button>\n            <button id="readergpt__closeButton" type="button" class="btn btn-close"></button>\n          </div>\n        </div>\n      </nav>\n      <div id="readergpt__summarySection">\n        <div class="card d-none" id="readergpt__loginContainer">\n          <div class="card-body">\n            <p class="card-text">Please\n              <a href="https://chat.openai.com" target="_blank" rel="noreferrer" id="readergpt__loginButton"\n                class="card-link">Login</a> to OpenAI. Do refresh this page after login.\n            </p>\n            <p class="card-text mt-2"><small class="text-muted">ChatGPT requires logging in to OpenAI once in a while to\n                use.</small>\n            </p>\n            <div class="alert alert-success" role="alert"> Now you can use OpenAI API Key to avoid repeat login and super\n              fast response.<br /><a href="${l}" target="_blank" class="alert-link">Click here</a> for one time setup.\n            </div>\n            <p id="readergpt__braveWarning" class="card-text mt-2 alert alert-warning d-none"> To use it on Brave, please\n              ensure that the <a href="https://i.imgur.com/9F6cTvD.png" target="_blank">fingerprinting setting</a> is\n              disabled in brave://settings/shields\n            </p>\n          </div>\n        </div>\n        <div id="readergpt__gifContainer" class="align-middle mt-3 mb-3 d-none">\n          <span class="spinner-border text-primary mt-2" role="status"></span>\n          <span class="align-middle readergpt__readableText">Summarising with AI</span>\n        </div>\n      </div>\n      <p id="readergpt__readableText" role="alert" class="readergpt__readableText alert alert-secondary d-none"></p>\n      </p>\n      <div id="readergpt__footer__wrapper" class="readergpt__footer__wrapper d-none">\n        <button id="copyBtn">\n          <img src="${h}" />\n          <span>Copy</span>\n        </button>\n        <button class="readergpt__footer__btn">\n          <img src="${d}"/>\n          <a id="readergpt__link"\n            href="https://chrome.google.com/webstore/detail/${chrome.runtime.id}/reviews"\n            target="_blank" class="d-flex justify-content-end text-decoration-none">Rate us!\n        </button>\n      </div>\n    </div>`, 
            null === (e = a.shadowRoot) || void 0 === e || e.appendChild(r), null === (i = document.getElementsByTagName("body")[0]) || void 0 === i || i.append(a), 
            setTimeout((() => {
                var e;
                ...
                i && i.brave && i.brave.isBrave && i.brave.isBrave().then((e => {
                    var t;
                    e && (null === (t = o("readergpt__braveWarning")) || void 0 === t || t.classList.remove("d-none"));
                }));
            }), 500);
        }(), a && a.textContent ? function(e) {
            let t, i = chrome.runtime.connect();
            i.onMessage.addListener((e => {
                let i, a;
                if ("DONE" === e.event) return s(), null === (i = o("readergpt__summaryTextHeader")) || void 0 === i || i.classList.remove("d-none"), 
                null === (a = o("1")) || void 0 === a || a.classList.remove("d-none"), null === (a = o("readergpt__footer__wrapper")) || void 0 === a || a.classList.remove("d-none"), 
                void document.getElementById("readergpt__shadowRoot").shadowRoot.getElementById("copyBtn").addEventListener("click", (() => {
                    navigator.clipboard.writeText(t);
                }));
                if (e.text) return function(e) {
                    var t, i, a;
                    null === (t = o("readergpt__readableText")) || void 0 === t || t.classList.remove("d-none"), 
                    null === (i = o("readergpt__readableText")) || void 0 === i || i.classList.add("alert-secondary"), 
                    null === (a = o("readergpt__readableText")) || void 0 === a || a.classList.remove("alert-warning"), 
                    o("readergpt__readableText").innerText = e;
                }(e.text), void (t = e.text);
                if (e.error) {
                    s();
                    try {
                        let t = e.error, i = null == t ? void 0 : t.code, a = null == t ? void 0 : t.message;
                        if ("CLOUDFLARE" === i || "UNAUTHORIZED" === i) return void function() {
                            var e;
                            null === (e = o("readergpt__loginContainer")) || void 0 === e || e.classList.remove("d-none");
                        }();
                        if ("message_length_exceeds_limit" === i) return void r("Article is too long and is not supported by ChatGPT yet. Stay tuned for a workaround.");
                        if (a) return void r(a);
                    } catch (e) {}
                    r("Something went wrong, please refresh the page.");
                }
            })), function() {
                var e, t, i;
                null === (e = o("readergpt__loginContainer")) || void 0 === e || e.classList.add("d-none"), 
                null === (t = o("readergpt__summaryTextHeader")) || void 0 === t || t.classList.add("d-none"), 
                null === (i = o("readergpt__buyMeACoffee")) || void 0 === i || i.classList.add("d-none");
            }(), function() {
                var e, t, i, a;
                null === (e = o("readergpt__gifContainer")) || void 0 === e || e.classList.remove("d-none"), 
                null === (t = o("readergpt__gifContainer")) || void 0 === t || t.classList.add("loading"), 
                null === (i = o("readergpt__loginContainer")) || void 0 === i || i.classList.add("loading"), 
                null === (a = o("readergpt__readableText")) || void 0 === a || a.classList.add("d-none");
            }(), i.postMessage({
                pageContent: e
            });
        }(a.textContent) : r("No readable text found on the page.");
    })();
})();