...
;// CONCATENATED MODULE: ../../fragment/cookie-banner-detection/dist/shared/cookie-banner-detection.types.js
const detectionEventName = "CookieBannerDetected";
const detectionMessage = "cookie-banner.detected";

;// CONCATENATED MODULE: ../../fragment/cookie-banner-detection/dist/content/cookie-banner-detection.js


function forwardDetectionEvent() {
    void browser_polyfill.runtime.sendMessage({ type: detectionMessage });
}
function start() {
...
;// CONCATENATED MODULE: ../../fragment/cookie-banner-detection/dist/content/index.js
