(function() {
    ...
    var PSLocalization = {
        ...
        CONCERN_TITLE : "Обнаружены угрозы конфиденциальности (%d).",
        CONCERN_TITLE_ONE_CONCERN : "Обнаружены угрозы конфиденциальности (%d).",
        ...
        HTML_FOOTER_COPYRIGHT : "© 2025 Trend Micro Incorporated. Все права защищены.",
