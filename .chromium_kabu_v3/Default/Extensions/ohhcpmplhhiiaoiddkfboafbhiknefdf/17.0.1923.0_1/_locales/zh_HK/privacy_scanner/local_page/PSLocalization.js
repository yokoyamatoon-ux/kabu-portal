(function() {
    ...
    var PSLocalization = {
         ...
         */
        HEADER_GETHELP_LINK : "http://gr.trendmicro.com/GREntry/NonPayment?PID=TEG0&Locale=ZH-HK&SP=F&VID=&Target=OLH&FunID=100002",
        /*
         overlay area
         */
        ...
        OVERLAY_FACEBOOK_FIND_ANOTHER_ACCOUNT_SUDDENDLY : "您似乎已變更為其他 Facebook 帳號。是否要改為檢查此帳號?",
        OVERLAY_TWITTER_FIND_ANOTHER_ACCOUNT_SUDDENDLY : "您似乎已改成使用其他 X 帳號。是否要改為檢查此帳號？",
        OVERLAY_GOOGLEPLUS_FIND_ANOTHER_ACCOUNT_SUDDENDLY : "您似乎已變更為其他 Google+ 帳號。是否要改為檢查此帳號?",
        OVERLAY_LINKEDIN_FIND_ANOTHER_ACCOUNT_SUDDENDLY : "您似乎已變更至不同的 LinkedIn 帳號。您是否要改為檢查此帳號？",
        
        OVERLAY_TWITTER_CONFIRM_PASSWORD : "現在您已確認密碼，點擊按鈕可查看結果。",
        OVERLAY_LINKEDIN_CONFIRM_PASSWORD : "現在您已登入，點擊「確定」以查看結果。",

        OVERLAY_FACEBOOK_HAVE_SIGN_IN_ANOTHER_ACCOUNT : "現在您已登入正確的帳號，請點擊下面的按鈕。",
        OVERLAY_TWITTER_HAVE_SIGN_IN_ANOTHER_ACCOUNT : "現在您已登入正確的帳號，請點擊下面的按鈕。",
        OVERLAY_GOOGLEPLUS_HAVE_SIGN_IN_ANOTHER_ACCOUNT : "現在您已登入正確的帳號，請點擊下面的按鈕。",
        OVERLAY_LINKEDIN_HAVE_SIGN_IN_ANOTHER_ACCOUNT : "現在您已登入正確的帳號，請點擊下面的按鈕。",
        ...
        OVERLAY_PROMOTE_USER_INPUT_PASSWORD : "為了保護您的安全，您現在必須再次提供您的 X 密碼，以確認這些變更。點擊此按鈕以繼續。",
        OVERLAY_PROMOTE_USER_INPUT_PASSWORD_CHECKBOX_TITLE : "不要再提及此項",
        
        OVERLAY_PROMOTE_USER_INPUT_PASSWORD_LINKEDIN : "為了您的安全，您必須現在再次登入 LinkedIn 以確認這些變更。請點擊該按鈕以繼續。",
        ...
        CONCERN_TITLE : "我們發現 %d 個隱私安全問題。",
        CONCERN_TITLE_ONE_CONCERN : "我們發現 %d 個隱私安全問題。",
        ...
        SHARE_TOOTHERS_SNS_TITLE : "趨勢科技網路隱私偵測可協助在社群網路上保護我的隱私權。歡迎您來試用！",
        SHARE_TOOTHERS_BROWSER_TITLE : "趨勢科技網路隱私偵測可讓我的 Web 瀏覽器更安全。歡迎您來試用！",
        ...
        SAVE_CHANGES_TWITTER_HINT : "如果準備做出變更，請點擊按鈕並確認您的 X 密碼。",
        SAVE_CHANGES_FIRSTTIME_HINT : "當您準備好儲存下面的任何變更時，請點擊這裡",
        ...
        HTML_FOOTER_COPYRIGHT : "版權所有 © 2025 Trend Micro Incorporated / 趨勢科技有限公司。保留所有權利。",
        ...
        /*
         busy fixing
         */
        BUSY_FIXING_HINT : "對於造成的不便，我們深感抱歉，但我們必須在這裡做出一些改進，從而與此社群網路的最近變更保持一致。同時，您可以改為檢查其他任一帳號。",

        /*
         enable toolbar
         */
        ENABLE_TOOLBAR_HINT : "開啟 Trend Micro 工具列以檢查您的隱私權。",
        ENABLE_TOOLBAR_LINK : "http://gr.trendmicro.com/GREntry/NonPayment?TARGET=iKB&FunID=Privacy_Scan_2&Locale=ZH-HK",
        ...
        GET_MORE_HELP : "請點擊這裡以取得其他說明。",
        ALERT_UNABLE_TO_OPEN_SETTING_PAGE_LEARN_MORE : "如果持續看到此訊息，請點擊這裡取得說明。",
        ALERT_BUY_TITANIUM_BUTTON : "立即購買",
        ALERT_RESTART_BUTTON : "重新啟動",
        ALERT_CHROME_ACCOUNT_LOGGED_IN_TITLE : "Trend Micro PrivacyScanner 使用 Google Chrome 時遇到問題。",
        ALERT_CHROME_ACCOUNT_LOGGED_IN_LEARN_MORE : "請點擊這裡以取得修正此問題的簡易指示。",
        ...
        */
        ...
        ERROR_IE_VERSION_TOO_LOW : "請先升級為最新版本的 Microsoft Internet Explorer，然後點擊以下按鈕。",
        ...
        */
        ...
        OVERLAY_REMOVE_FACEBOOK_APPLICATION:"這會將您的 Facebook 帳號中移除此應用程式，並且不會再存在於您的書籤或曾經使用過的應用程式清單中。<a href='https://www.facebook.com/help/234899866630865' target='_blank'>深入瞭解</a>", //Please just translate the "Learn more", keep the html element.
        fb_app_level_friends_wording:"朋友",
        fb_app_level_FriendsOfFriends_wording:"朋友的朋友",
        fb_app_level_public_wording:"公用",
        fb_app_level_onlyme_wording:"只有我",
        fb_app_extend_wording:"顯示較多內容",
        ...
        tw_str_fix_pop2:"完成密碼輸入後，請點擊「確定」來修正問題。"
    };
    /////////////L10N string end//////////////////
    var exports = window;
