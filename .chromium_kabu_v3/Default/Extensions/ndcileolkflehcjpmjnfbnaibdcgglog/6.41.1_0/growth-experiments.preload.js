...
;// CONCATENATED MODULE: ./src/growth-experiments/shared/growth-experiments.types.ts
const eventPrefix = "GrowthExperiment__";
const messageIdentifier = "growthExperiment";

;// CONCATENATED MODULE: ./src/growth-experiments/shared/cookie-banner.types.ts

const cookieBannerPrefix = "CookieBanner--";
const cookieBannerEventNames = {
    siteDetected: `${eventPrefix}${cookieBannerPrefix}SiteDetected`,
    cpmMessageDetected: `${eventPrefix}${cookieBannerPrefix}CpmMessageDetected`,
    buttonInjected: `${eventPrefix}${cookieBannerPrefix}ButtonInjected`,
    buttonClicked: `${eventPrefix}${cookieBannerPrefix}ButtonClicked`,
};

;// CONCATENATED MODULE: ./src/growth-experiments/shared/index.ts



;// CONCATENATED MODULE: ./src/growth-experiments/content/event-forwarding.ts


function forwardEvent(name) {
    void browser_polyfill_default().runtime.sendMessage({ type: messageIdentifier, name });
}
function start() {
    [
        cookieBannerEventNames.cpmMessageDetected,
        cookieBannerEventNames.buttonInjected,
        cookieBannerEventNames.buttonClicked,
    ].forEach((eventName) => {
...
;// CONCATENATED MODULE: ./src/growth-experiments/content/index.ts
